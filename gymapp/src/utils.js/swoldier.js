...
export const EXERCISES = {
  ...
  seated_row: {
    ...
    muscles: ["back"],
    description:
      "With your back vertical, row your elbows back and imagine pulling your hands to your hips on either side of your body. Ensure to minimize torso and hip hinging during the movement. Row low to grow.",
  ...
  box_squats: {
    ...
    muscles: ["quads"],
    description:
      "With a barbell on your shoulders, bodyweight, or holding a dumbbell, situate yourself standing infront of, and facing away from, a box or chair or similar elevated surface. Position your feet shoulder width apart, and slow squat down, as if sitting back to sit down on the chair. Only lightly let your bum touch the chair, before standing back up.",
    substitutes: ["front squats", "legpress"],
  },
  ...
  step_ups: {
    ...
    muscles: ["quads", "glutes"],
    description:
      "Without jumping, step up onto an elevated surface. They key is to slowly lower yourself back down on one leg without falling.",
  ...
  hip_thrusts: {
    ...
    muscles: ["glutes"],
    description:
      "With your back rest on an elevated surface, or on the ground, and your knees bent to approximately 90 degrees, thrust your hips forward and tuck your chin. Without moving your heels, try to pull them back towards your bum throughout the motion.",
  ...
  unilateral_hip_thrusts: {
    ...
    muscles: ["glutes"],
    description:
      "With your back rest on an elevated surface, or on the ground, and one knee bent to approximately 90 degrees (the other leg extended), thrust your hips forward and tuck your chin. Without moving your heel, try to pull them back towards your bum throughout the motion.",
    substitutes: ["cable kickbacks"],
  },
  deadlift: {
    type: "compound",
  ...
  seated_calf_raises: {
    ...
    muscles: ["calves"],
    description:
      "Seated with a restraint above your knees, you want to plantar flex your toes, pushing your knees away from the ground.",
  ...
  skull_crushers: {
    ...
    muscles: ["triceps"],
    description:
      "Lie either on a flat or on a slightly inclined surface with a barbell directly above your skull. Starting with your arms straight, lower the weight down either to your forehead, or down behind your head and then press it back up. Vary your grip width to whatever is most comfortable for you and keep your elbows tucked throughout the movement.",
